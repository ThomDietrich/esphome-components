...
namespace wmbus {
  ...
  void WMBusComponent::loop() {
    ...
    if (rf_mbus_.task()) {
      ...
      frame = "5344a5119955758176078c0028900f002c2577010000968ef8fBe33061Bf7a6700310710a897ec701e67cf0a62f6c55258c1Be7d3825361a07c4224f96f0B6e22Be48Bae5a5ac859524Ba853de0166275df9c626";
      // int i{0};
      // frame[i++] = '5';
      // frame[i++] = '3';
      // frame[i++] = '4';
